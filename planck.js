...
(function() {
  define([], function() {
    var Planck, axisW, c1_boltzman, c2_boltzman, c_wien, d3, expwn, i, makeSeries, padding, plancksLaw, sidebarWidth, sliderCircle, temperatures, wavelengths, wiens, wiensLaw, xDomain, yDomain;
    d3 = null;
    c1_boltzman = 3.74e8;
    c2_boltzman = 1.44e4;
    c_wien = 2898;
    ...
    Planck = function(_d3) {
      ...
      api = function(selection) {
        var clip, defs, el_xAxis, el_yAxis, explore, handleLabel, handleSolution, plotSvg, plots, plotsBg, render, resize, slide, slideHandle, slider, sliderReferences, solutions, wavelengthLabel, wienSeries, xLabel, yLabel;
        selection.classed({
          planck: true
        });
        explore = function() {
          WAVELENGTH = xScale.invert(d3.mouse(this)[0]);
          return render();
        };
        render = function() {
        ...
        resize = api.resize = function() {
          ...
          sliderScale.range([HEIGHT - (sliderCircle.r * 4), sliderCircle.r * 4]);
          slider.attr({
            transform: "translate(" + (WIDTH - sidebarWidth + 20) + ", 0)"
          });
        ...
        plotSvg = selection.selectAll(".plot.planck").data([1]).call(function(plotSvg) {
          ...
          plotSvg.append("g").classed({
            ...
            yLabel.append("tspan").text("Wavelength");
            return yLabel.append("tspan").classed({
              unit: true
            }).text(" [µm]");
          });
        ...
        slider = plotSvg.selectAll(".slider").data([1]).call(function(slider) {
          ...
          slider.append("text").classed({
            ...
            sliderLabel.append("tspan").text("T");
            return sliderLabel.append("tspan").text("[°K]").classed({
              unit: true
            });
          });
          ...
          return slider.append("g").classed({
            ...
            slideHandle.append("text").classed({
              temperature: true
            }).attr({
              dy: ".35em",
              x: sliderCircle.cx,
            ...
            return slideHandle.append("text").classed({
              solution: true
            }).attr({
              "text-anchor": "end",
              dy: ".35em",
